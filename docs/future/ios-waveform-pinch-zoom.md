...
- **The anchor is free.** The design invariant `position.x + progress·virtualWidth == centerX` means zoom is inherently anchored at the playhead. No anchor math, and it is the right DJ behavior.
