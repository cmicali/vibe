...
static NSDictionary *VibeStateDictionary(MainPlayerController *controller) {
    ...
    return @{
        @"player": @{
            ...
            @"lowKill": @(player.lowKillEnabled),
            @"lowKillBoost": @(player.lowKillBoostActive),
            @"reverbSend": @(player.reverbSendEnabled),
            @"delaySend": @(player.delaySendEnabled),
            @"delayTapBPM": @(player.delayTapBPM),
