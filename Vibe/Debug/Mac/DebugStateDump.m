...
NSDictionary *VibeStateDictionary(MainPlayerController *controller) {
    ...
    [state addEntriesFromDictionary:@{
        ...
        @"settings": @{
            ...
            @"waveformStyle": AppSettings.sharedInstance.currentTheme.waveformStyle,
            @"windowAppearance": AppSettings.sharedInstance.windowAppearanceStyle ?: @"",
            @"waveformTheme": AppSettings.sharedInstance.currentTheme.waveformTheme,
            ...
            @"showBPM": @(AppSettings.sharedInstance.currentTheme.showBPM),
            @"showKey": @(AppSettings.sharedInstance.currentTheme.showKey),
            @"showTrafficLights": @(AppSettings.sharedInstance.showTrafficLights),
            @"windowTint": AppSettings.sharedInstance.currentTheme.windowTint,
            ...
            @"keyNotation": AppSettings.sharedInstance.currentTheme.keyNotation,
            @"keyColors": @(AppSettings.sharedInstance.currentTheme.keyColorsEnabled),
            ...
            @"mainFont": [NSString stringWithFormat:@"%@ %g",
                    AppSettings.sharedInstance.currentTheme.mainFontFace,
                    AppSettings.sharedInstance.currentTheme.mainFontSize],
            @"infoFont": [NSString stringWithFormat:@"%@ %g",
                    AppSettings.sharedInstance.currentTheme.infoFontFace,
                    AppSettings.sharedInstance.currentTheme.infoFontSize],
            @"playlistFont": [NSString stringWithFormat:@"%@ %g",
                    AppSettings.sharedInstance.currentTheme.playlistFontFace,
                    AppSettings.sharedInstance.currentTheme.playlistFontSize],
        },
    }];
    return state;
}
