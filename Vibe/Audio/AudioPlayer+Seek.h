...
//  - **Unscheduling a stale splice reuses this whole path**, through the public
//    seekToPosition: — the fade down/reschedule/fade up dance is the only
//    click-free way to drop a queued segment. It costs one spurious
//    didFinishSeeking:, which only settles UI.
//
