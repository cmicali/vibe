...
// Whether path lies at or under root. Case-sensitive: both sides are canonical
// on-disk spellings by the time noteOpenedURLs: compares them, and on a
// case-SENSITIVE volume a loose match here would skip a bookmark the app
// actually needs.
...
// straight off Launch Services or a pasteboard. Deliberately case-insensitive,
// which is the safe direction here: over-matching only makes an open wait for
// a grant it did not need, while under-matching walks a path whose grant has
