//
//  WaveformLoadingIndicator.h
//  Vibe
//
//  The waveform's loading control, owned by both waveform views. It is pure
...
//
//  IT IS ONE CONTROL ACROSS BOTH MODES, not a shimmer with a progress bar
//  added: a faint full-width midline track, a solid filled head over
...
//  negative fraction reverts cleanly.
//
...
@interface WaveformLoadingIndicator : NSObject
...
// Determinate download progress: the midline fills from the left as the
