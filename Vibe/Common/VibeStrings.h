...
#define STR_SETTINGS_ON_END_PLAY_NEXT    NSLS(@"settings.playback.on_end.play_next",            @"Play next song in playlist", @"Settings, Playback pane, choice for what happens when a track finishes: playback continues with the following track in the playlist. The default.")
...
#define STR_SETTINGS_WAVEFORM_THEME_LABEL NSLS(@"settings.appearance.waveform_theme_label",     @"Waveform theme:",          @"Settings, Appearance pane, and the iOS settings screen: label beside the dropdown choosing the waveform's color palette (as opposed to its drawing style). Ends with a colon.")
#define STR_SETTINGS_WAVEFORM_THEME_WHITE NSLS(@"settings.appearance.waveform_theme.white",     @"White",                    @"Settings, waveform color theme choice: the monochrome default — white-based in dark mode, black-based in light. The default.")
...
#define STR_SETTINGS_WAVEFORM_THEME_ALBUM_ART NSLS(@"settings.appearance.waveform_theme.album_art", @"Album art",            @"Settings, waveform color theme choice (macOS only): the played color is derived from the current track's cover artwork.")
...
#define STR_SETTINGS_WAVEFORM_CUSTOM_LABEL NSLS(@"settings.appearance.waveform_custom_label",   @"Custom colors:",           @"Settings, Appearance pane: label beside the two color wells shown when the waveform theme is Custom. Ends with a colon.")
#define STR_SETTINGS_WAVEFORM_CUSTOM_PLAYED NSLS(@"settings.appearance.waveform_custom.played", @"Played",                   @"Settings, custom waveform colors: caption under the color well for the part of the waveform already played.")
#define STR_SETTINGS_WAVEFORM_CUSTOM_UNPLAYED NSLS(@"settings.appearance.waveform_custom.unplayed", @"Unplayed",             @"Settings, custom waveform colors: caption under the color well for the part of the waveform not yet played.")
...
#define STR_SETTINGS_ALBUM_ART_FOLDER     NSLS(@"settings.files.album_art.folder",              @"File first, then search folder", @"Settings, Files pane, album art choice: prefer the artwork stored inside the song file, and for a song carrying none use a cover image file sitting beside it in the same folder. The default.")
...
#define STR_SETTINGS_PERMISSIONS_EXPLAIN  NSLS(@"settings.permissions.explain",                 @"Vibe can read music in these folders. Add the ones you use often to avoid repeated permission prompts.", @"Settings, Files pane: explanatory text above the list of granted folders.")
...
#define STR_SETTINGS_FOLDER_UNAVAILABLE_TIP NSLS(@"settings.permissions.folder.unavailable.tip", @"This folder is missing, or on a disk that isn’t connected. Vibe keeps its permission and will use it again if it comes back.", @"Settings, Files pane, granted-folder list: tooltip on a dimmed row, explaining why an unreachable folder is still listed. Uses a curly apostrophe (’).")
#define STR_SETTINGS_FOLDER_GRANT_MESSAGE NSLS(@"settings.permissions.folder_grant.message",    @"Grant Vibe access to “%@”, so it can read music anywhere inside it.", @"Message atop the folder-picker panel opened from the Add Common Folder menu, which starts in the chosen folder. %@ is that folder's name, e.g. 'Documents'.")
