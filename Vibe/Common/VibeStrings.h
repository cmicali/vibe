...
#define STR_SETTINGS_PERMISSIONS          NSLS(@"settings.permissions",                         @"Permissions",              @"Settings window: the Permissions pane's toolbar item, and the window's title while that pane is selected. The pane lists the folders the app keeps access to.")
#define STR_SETTINGS_PERMISSIONS_EXPLAIN  NSLS(@"settings.permissions.explain",                 @"Vibe can read music in these folders. Add the ones you use often to avoid repeated permission prompts.", @"Settings, Permissions pane: explanatory text above the list of granted folders.")
#define STR_SETTINGS_ADD_FOLDER           NSLS(@"settings.permissions.add_folder",              @"Add Folder…",              @"Settings, Permissions pane: button that opens a folder chooser to grant the app access to another folder. Ends with a real ellipsis character (…), not three periods.")
#define STR_SETTINGS_ADD_COMMON_FOLDER    NSLS(@"settings.permissions.add_common_folder",       @"Add Common Folder",        @"Settings, Permissions pane: pull-down button whose menu grants the app access to one of the usual music locations — the home folder, Documents, iCloud Drive or Dropbox.")
#define STR_SETTINGS_FOLDER_HOME          NSLS(@"settings.permissions.folder.home",             @"Home Folder",              @"Settings, Permissions pane, Add Common Folder menu: the user's home folder. Use the name the Finder gives it in this language.")
#define STR_SETTINGS_FOLDER_DOCUMENTS     NSLS(@"settings.permissions.folder.documents",        @"Documents",                @"Settings, Permissions pane, Add Common Folder menu: the Documents folder inside the user's home folder. Use the name the Finder gives it in this language.")
#define STR_SETTINGS_FOLDER_NOT_FOUND     NSLS(@"settings.permissions.folder.not_found",        @"%@ (Not found)",           @"Settings, Permissions pane, Add Common Folder menu: a disabled entry for a folder that does not exist on this Mac. %@ is the folder's name, e.g. 'Dropbox'.")
#define STR_SETTINGS_FOLDER_ALREADY_ADDED NSLS(@"settings.permissions.folder.already_added",    @"%@ (Already accessible)",  @"Settings, Permissions pane, Add Common Folder menu: a disabled entry for a folder the app can already read, because it or a folder above it is in the list. %@ is the folder's name, e.g. 'Documents'.")
...
#define STR_SETTINGS_REMOVE_FOLDER        NSLS(@"settings.permissions.remove",                  @"Remove",                   @"Settings, Permissions pane: button that removes the selected folder from the granted list, giving up the app's access to it.")
