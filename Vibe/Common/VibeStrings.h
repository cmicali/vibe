...
#define STR_SETTINGS_WINDOW_SECTION     NSLS(@"settings.general.window_section", @"Window",                        @"Settings, General pane: heading above the window-behavior rows — always on top, and what dragging the waveform does.")
...
#define STR_SETTINGS_WAVEFORM_DRAG_LABEL NSLS(@"settings.appearance.waveform_drag_label",       @"Drag behavior",            @"Settings, General pane, Window group: row beside the dropdown choosing what dragging the mouse on the waveform does. The key keeps its historical settings.appearance prefix.")
...
#define STR_SETTINGS_STATS_SECTION        NSLS(@"settings.advanced.stats_section",              @"Statistics",               @"Settings, Advanced pane: heading above the group of lifetime playback-statistics rows.")
