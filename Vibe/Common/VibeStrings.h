...
#define STR_SETTINGS_THEME_ALBUM_ART           NSLS(@"settings.appearance.theme.album_art",           @"Default artwork",                    @"Theme editor, Player group: row beside the dropdown choosing the placeholder image shown when a track has no artwork.")
#define STR_SETTINGS_THEME_ALBUM_ART_DEFAULT   NSLS(@"settings.appearance.theme.album_art_default",   @"Default",                      @"Theme editor, Album art dropdown: the factory record image.")
#define STR_SETTINGS_THEME_ALBUM_ART_CUSTOM    NSLS(@"settings.appearance.theme.album_art_custom",    @"Custom…",                      @"Theme editor, Album art dropdown: pick a square JPEG or PNG of your own; opens a file panel.")
