...
#define STR_SETTINGS_THEME_BUTTON_PLAYLIST_IMAGE NSLS(@"settings.appearance.theme.button_playlist_image", @"Playlist button image",          @"Theme editor, Player group: row beside the playlist button's custom image preview; shown once a custom image replaces the symbol.")
#define STR_SETTINGS_THEME_BUTTON_PLAY_IMAGE   NSLS(@"settings.appearance.theme.button_play_image",   @"Play button images",                 @"Theme editor, Player group: row beside the play/pause button's two custom image previews, captioned Play and Pause; shown once a custom image replaces the symbols.")
#define STR_SETTINGS_THEME_BUTTON_NEXT_IMAGE   NSLS(@"settings.appearance.theme.button_next_image",   @"Next button image",                  @"Theme editor, Player group: row beside the next-track button's custom image preview; shown once a custom image replaces the symbol.")
