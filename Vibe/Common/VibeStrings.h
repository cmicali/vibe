...
#define STR_SETTINGS_THEME_RANDOMIZE           NSLS(@"settings.appearance.theme.randomize",           @"Randomize",                    @"Settings toolbar: label of the theme editor's two-segment dice control (icon-only on screen; read by VoiceOver and the customize sheet).")
