...
#define STR_SETTINGS_WAVEFORM_DRAG_LABEL NSLS(@"settings.appearance.waveform_drag_label",       @"Waveform drag:",           @"Settings, Appearance pane: label beside the dropdown choosing what dragging the mouse on the waveform does. Ends with a colon.")
