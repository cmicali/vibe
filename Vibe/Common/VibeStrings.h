...
#define STR_SETTINGS_THEME_BACK                NSLS(@"settings.appearance.theme.back",                @"Back",                         @"Theme editor: button returning from the editor page to the theme list, like a System Settings sub-page's back control.")
...
#define STR_SETTINGS_PLAYLIST_SECTION          NSLS(@"settings.appearance.playlist_section",          @"Playlist",                     @"Theme editor: heading above the playlist color rows.")
#define STR_SETTINGS_THEME_PLAYLIST_BACKGROUND NSLS(@"settings.appearance.theme.playlist_background", @"Playlist background",          @"Theme editor, Playlist group: row beside the color wells washing the playlist area's background.")
