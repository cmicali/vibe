...
#define STR_SETTINGS_EXCLUSIVE_OUTPUT_NEEDS_DEVICE NSLS(@"settings.general.exclusive_output.needs_device", @"Choose a wired device other than system output", @"Settings: exclusive output is unavailable for virtual devices and the system output device. No trailing period.")
#define STR_SETTINGS_BIT_PERFECT_NEEDS_DEVICE  NSLS(@"settings.general.bit_perfect.needs_device",   @"Choose a wired device", @"Settings, General pane: caption under the disabled bit-perfect output switch while the output is System Output or a Bluetooth, AirPlay or other device the mode cannot drive. No trailing period.")
