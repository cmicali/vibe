...
#define STR_MENU_APPEARANCE_SYSTEM  NSLS(@"menu.view.appearance.system", @"Light & Dark",       @"Appearance choice, View menu and theme editor: the theme adapts — separate colors for the system's light and dark modes, following its setting.")
#define STR_MENU_APPEARANCE_LIGHT   NSLS(@"menu.view.appearance.light",  @"Always Light",       @"Appearance choice, View menu and theme editor: a single-look theme pinned to the light appearance — one set of colors regardless of the system's mode.")
#define STR_MENU_APPEARANCE_DARK    NSLS(@"menu.view.appearance.dark",   @"Always Dark",        @"Appearance choice, View menu and theme editor: a single-look theme pinned to the dark appearance — one set of colors regardless of the system's mode.")
...
#define STR_SETTINGS_THEME_APPEARANCE          NSLS(@"settings.appearance.theme.appearance",          @"Appearance",                   @"Theme editor, Window group: row beside the dropdown choosing whether the theme follows the system's light/dark setting (Auto) or pins one appearance, making it a fixed single-look theme.")
...
#define STR_SETTINGS_THEME_PLAYLIST_BACKGROUND_COLORS NSLS(@"settings.appearance.theme.playlist_background_colors", @"Playlist background colors", @"Theme editor, Playlist group: row beside the playlist background's two color wells, one per appearance — the wash over glass, or the solid cover.")
