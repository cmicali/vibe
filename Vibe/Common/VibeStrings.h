...
#define STR_SETTINGS_ADD_HOME_FOLDER      NSLS(@"settings.permissions.add_home_folder",         @"Add Home Folder",          @"Settings, Permissions pane: button that grants the app access to the user's whole home folder in one step. Disabled once that access is held.")
#define STR_SETTINGS_HOME_GRANT_MESSAGE   NSLS(@"settings.permissions.home_grant.message",      @"Grant Vibe access to your home folder, so it can read music anywhere inside it.", @"Message atop the folder-picker panel opened by the Add Home Folder button, which starts in the user's home folder.")
#define STR_SETTINGS_HOME_GRANT_BUTTON    NSLS(@"settings.permissions.home_grant.button",       @"Grant Access",             @"Confirm button of the folder-picker panel opened by the Add Home Folder button.")
