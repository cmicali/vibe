...
#define STR_SETTINGS_THEME_ALBUM_ART           NSLS(@"settings.appearance.theme.album_art",           @"Album art",                    @"Theme editor, Player group: row beside the dropdown choosing the placeholder image shown when a track has no artwork.")
