...
#define STR_SETTINGS_ARTWORK_DRAG_NAME NSLS(@"settings.general.artwork_drag.copy_artist_title",  @"Copy artist / title",      @"Settings, General pane, artwork drag choice: the drop receives the song's name as text — 'Artist - Title' when both are tagged. Use the words for the performer and the song's name, separated by a slash.")
...
#define STR_SETTINGS_SETTINGS_LABEL       NSLS(@"settings.advanced.settings_label",             @"Settings:",                @"Settings, Advanced pane: label beside the Reset to Defaults button. Use the word Apple uses for the Settings app in this language. Ends with a colon.")
