...
#define STR_SETTINGS_BIT_PERFECT_SWITCH_FAILED NSLS(@"settings.general.bit_perfect.switch_failed",  @"The device did not accept the sample rate change", @"Bit-perfect output status: the device was asked for the file's sample rate but did not confirm it in time.")
...
#define STR_SETTINGS_BIT_PERFECT_EXCLUSIVE_REFUSED NSLS(@"settings.general.bit_perfect.exclusive_refused", @"Another app has exclusive use of the device", @"Bit-perfect output status: the app could not take exclusive use of the device because another app already holds it.")
