...
#define STR_SETTINGS_THEME_BUTTON_PLAYLIST_COLOR NSLS(@"settings.appearance.theme.button_playlist_color", @"Playlist button color",          @"Theme editor, Player group: row beside the playlist button's symbol color wells, one per appearance.")
#define STR_SETTINGS_THEME_BUTTON_PLAY_COLOR   NSLS(@"settings.appearance.theme.button_play_color",   @"Play button color",                  @"Theme editor, Player group: row beside the play/pause button's symbol color wells, one per appearance.")
#define STR_SETTINGS_THEME_BUTTON_NEXT_COLOR   NSLS(@"settings.appearance.theme.button_next_color",   @"Next button color",                  @"Theme editor, Player group: row beside the next-track button's symbol color wells, one per appearance.")
