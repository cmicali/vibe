...
#define STR_SETTINGS_AUDIO_PATH_LATENCY        NSLS(@"settings.advanced.audio_path.latency",        @"%@ ms latency",             @"Settings, Advanced pane, Audio group: the delay the pitch resampler adds, e.g. '1.0 ms latency'. %@ is the already-formatted milliseconds; ms is the unit symbol and is not translated.")
