...
#define STR_MENU_APPEARANCE_SYSTEM  NSLS(@"menu.view.appearance.system", @"Auto",               @"Appearance choice in Settings: follow the system's light/dark setting. macOS System Settings names this choice Auto, beside Light and Dark — use the same word.")
...
#define STR_SETTINGS_AUDIO_SECTION      NSLS(@"settings.general.audio_section", @"Audio",                          @"Settings window: the Audio pane sidebar item and title, for output device, bit-perfect output and exclusive output.")
...
#define STR_SETTINGS_REOPEN_PLAYLIST         NSLS(@"settings.general.reopen_playlist",         @"Load last playlist on launch", @"Settings, General pane, Startup group: switch that brings the previous session's playlist back when the app launches, paused. Sentence case, like the other switches.")
#define STR_SETTINGS_REOPEN_PLAYLIST_CAPTION NSLS(@"settings.general.reopen_playlist.caption", @"Playlist is saved on quit and loaded on next launch", @"Settings, General pane: caption under the 'Load last playlist on launch' switch. One sentence, no trailing period, saying when the playlist is saved and when it comes back.")
...
#define STR_SETTINGS_BIT_PERFECT_IDLE          NSLS(@"settings.general.bit_perfect.idle",           @"On. Nothing is playing.", @"Settings, Audio pane: caption under the bit-perfect output switch while it is on and playback is stopped or paused.")
...
#define STR_SETTINGS_BIT_PERFECT_DEPTH         NSLS(@"settings.general.bit_perfect.depth",          @"File's bit depth is greater than the device can play", @"Bit-perfect output status: the file carries more bits per sample than the decoder or the device can pass on, so the audio is truncated. The decoder is 32-bit float, which carries 24 integer bits.")
...
#define STR_SETTINGS_BIT_PERFECT_VOLUME        NSLS(@"settings.general.bit_perfect.volume",         @"The device's volume is %@%%, set it to 100%% for bit-perfect output", @"Bit-perfect output status: macOS is scaling the audio in software because the device's volume is below full. %@ is the volume as a whole-number percentage; %% is a literal percent sign.")
#define STR_SETTINGS_BIT_PERFECT_BALANCE       NSLS(@"settings.general.bit_perfect.balance", @"System balance is not centered, center it for bit-perfect output", @"Bit-perfect output is scaling one channel because the system balance is not centered")
...
#define STR_SETTINGS_BIT_PERFECT_LOSSY         NSLS(@"settings.general.bit_perfect.lossy",          @"File is lossy, but bits out of the decoder are delivered unchanged", @"Bit-perfect output status: the file is a lossy format (MP3, AAC), so bit-perfect delivery applies to the decoded audio, not to a lossless original.")
...
#define STR_SETTINGS_THEME_COLOR_LABEL  NSLS(@"settings.appearance.theme.color_label",          @"Color:",                   @"Settings, theme editor: label beside a single color well, replacing the Dark/Light pair's labels when the theme keeps one set of colors for both appearances. Ends with a colon.")
#define STR_SETTINGS_THEME_COLORS_LABEL NSLS(@"settings.appearance.theme.colors_label",         @"Colors:",                  @"Settings, theme editor: label beside a pair of color wells (played and unplayed), replacing the Dark/Light labels when the theme keeps one set of colors for both appearances. Ends with a colon.")
#define STR_SETTINGS_WAVEFORM_SECTION   NSLS(@"settings.appearance.waveform_section",           @"Waveform",                 @"Settings, Appearance pane: heading above the group of waveform rows — style, normalize and gain.")
...
#define STR_SETTINGS_ICON_SECTION              NSLS(@"settings.appearance.icon_section",              @"Icon",                         @"Theme editor: heading above the app icon and Dock icon rows, the first card of the page.")
#define STR_SETTINGS_THEME_SHOW_TRANSPORT_BUTTONS NSLS(@"settings.appearance.theme.show_transport_buttons", @"Show transport buttons", @"Theme editor, Transport group: show or hide the playlist, play/pause and next buttons. Their appearance controls disable while hidden.")
...
#define STR_SETTINGS_TRANSPORT_SECTION         NSLS(@"settings.appearance.transport_section",         @"Transport",                    @"Theme editor: heading above the transport rows — the playlist, play and next buttons' symbols, colors and images, and the gradient behind them.")
#define STR_SETTINGS_PLAYER_SECTION            NSLS(@"settings.appearance.player_section",            @"Player",                       @"Theme editor: heading above the player rows — default artwork, the title and artist fonts and colors.")
#define STR_SETTINGS_INFO_SECTION              NSLS(@"settings.appearance.info_section",              @"Info",                         @"Theme editor: heading above the shared readout font, status icons, file info, tempo and key settings.")
...
#define STR_SETTINGS_THEME_BUTTON_GRADIENT     NSLS(@"settings.appearance.theme.button_gradient",     @"Button gradient",                    @"Theme editor, Transport group: switch showing or hiding the dark gradient shaded over the album art's lower edge behind the transport buttons.")
