...
#define STR_SETTINGS_BIT_PERFECT_FORMAT        NSLS(@"settings.general.bit_perfect.format",         @"%1$@ kHz · %2$@-bit",      @"The output format bit-perfect output settled on: %1$@ is the sample rate in kHz, %2$@ the word length in bits.")
#define STR_SETTINGS_BIT_PERFECT_FORMAT_EXCLUSIVE NSLS(@"settings.general.bit_perfect.format_exclusive", @"%1$@ kHz · %2$@-bit · exclusive", @"The output format bit-perfect output settled on, with the app holding exclusive use of the device: %1$@ is the sample rate in kHz, %2$@ the word length in bits.")
#define STR_SETTINGS_BIT_PERFECT_RATE_UNSUPPORTED NSLS(@"settings.general.bit_perfect.rate_unsupported", @"The device does not offer this file's sample rate; playing at %@ kHz", @"Bit-perfect output status: the device cannot run at the file's sample rate, so the audio is resampled. %@ is the rate the device is running at, in kHz.")
