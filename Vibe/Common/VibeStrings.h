...
#define STR_SETTINGS_WAVEFORM_THEME_LABEL NSLS(@"settings.appearance.waveform_theme_label",     @"Color",                     @"Settings, Appearance pane, Waveform group: row beside the dropdown choosing the waveform's color palette (as opposed to its drawing style).")
...
#define STR_SETTINGS_WAVEFORM_NORMALIZE_CAPTION NSLS(@"settings.appearance.waveform_normalize_caption", @"Draw every track with its loudest passage at full height.", @"Settings, Appearance pane, Waveform group: caption under the Normalize switch, saying what it does.")
...
#define STR_SETTINGS_WAVEFORM_GAIN_CAPTION NSLS(@"settings.appearance.waveform_gain_caption",   @"Lower it to see more of a loud track's dynamic range.", @"Settings, Appearance pane, Waveform group: caption under the Gain row, explaining the slider's second effect — turned down, a heavily limited track stops drawing as a flat block and its variation becomes visible.")
...
#define STR_SETTINGS_THEME_ALBUM_ART           NSLS(@"settings.appearance.theme.album_art",           @"Default artwork",                    @"Theme editor, Player group: row beside the artwork preview pair (one per appearance under Light & Dark Modes, one under Single Mode) showing the placeholder image used when a track has no artwork; clicking a preview opens a file panel to pick a square JPEG or PNG.")
#define STR_SETTINGS_THEME_ALBUM_ART_CLEAR     NSLS(@"settings.appearance.theme.album_art_clear",     @"Clear custom artwork",               @"Theme editor, accessibility label of the small ✕ badge revealed when hovering an artwork preview: removes that preview's picked custom image and returns to the factory record image.")
#define STR_SETTINGS_THEME_ALBUM_ART_MISSING   NSLS(@"settings.appearance.theme.album_art_missing",   @"Artwork missing",                    @"Theme editor, tooltip on the red (!) badge at an artwork preview's leading corner: the image this theme picked is no longer on this Mac, so the preview is drawing the factory placeholder instead. Clearing the artwork removes the badge.")
#define STR_SETTINGS_THEME_ALBUM_ART_INVALID   NSLS(@"settings.appearance.theme.album_art_invalid",   @"This image can’t be used.", @"Alert title when a picked album-art image fails validation.")
#define STR_SETTINGS_THEME_ALBUM_ART_REQUIREMENTS NSLS(@"settings.appearance.theme.album_art_requirements", @"The image must be a square JPEG or PNG, between 64 and 4096 pixels, under 8 MB.", @"Alert detail under the invalid-album-art title, stating every requirement.")
