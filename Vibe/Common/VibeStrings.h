...
#define STR_SETTINGS_THEME_BUTTON_GRADIENT     NSLS(@"settings.appearance.theme.button_gradient",     @"Button gradient",                    @"Theme editor, Player group: switch showing or hiding the dark gradient shaded over the album art's lower edge behind the transport buttons.")
