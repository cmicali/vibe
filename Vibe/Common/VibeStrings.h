...
#define STR_SETTINGS_FOLDER_SORT_MODIFIED NSLS(@"settings.files.sort_modified", @"Date modified, newest first", @"macOS Settings: Date modified, newest first")
#define STR_SETTINGS_FOLDER_SORT_UNSORTED NSLS(@"settings.files.sort_unsorted", @"Unsorted", @"macOS Settings: Unsorted")
#define STR_SETTINGS_WEBSITE NSLS(@"settings.about.website", @"Website", @"macOS Settings: Website")
#define STR_SETTINGS_LISTENING_TIME NSLS(@"settings.about.listening_time", @"Listening time", @"macOS Settings: Listening time")
#define STR_SETTINGS_NORMALIZE_WAVEFORM NSLS(@"settings.appearance.normalize_waveform", @"Normalize waveform", @"macOS Settings: Normalize waveform")
#define STR_SETTINGS_WAVEFORM_DISPLAY_GAIN NSLS(@"settings.appearance.waveform_display_gain", @"Waveform gain", @"macOS Settings: Waveform gain")
