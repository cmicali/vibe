...
#define STR_SETTINGS_BIT_PERFECT_LOSSY         NSLS(@"settings.general.bit_perfect.lossy",          @"File is lossy: bits after decode are delivered unchanged", @"Bit-perfect output status: the file is a lossy format (MP3, AAC), so bit-perfect delivery applies to the decoded audio, not to a lossless original.")
...
#define STR_SETTINGS_AUDIO_PATH_INT16          NSLS(@"settings.advanced.audio_path.int16",          @"16-bit integer",            @"Settings, Advanced pane, Audio group: the 16-bit integer sample format a lossy file is decoded to for a 16-bit device.")
