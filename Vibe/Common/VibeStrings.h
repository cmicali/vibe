...
#define STR_SETTINGS_INFO_SECTION              NSLS(@"settings.appearance.info_section",              @"Info",                         @"Theme editor: heading above the info-display rows — show file info and the tempo, key and time choices it governs.")
