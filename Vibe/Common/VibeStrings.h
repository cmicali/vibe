...
#define STR_SETTINGS_BIT_PERFECT_DEPTH         NSLS(@"settings.general.bit_perfect.depth",          @"The device's word length is shorter than this file's", @"Bit-perfect output status: the file carries more bits per sample than the device can take, so the audio is truncated.")
