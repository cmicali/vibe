...
#define STR_SETTINGS_PERMISSIONS_EXPLAIN  NSLS(@"settings.permissions.explain",                 @"Vibe always has access to your Music folder. Other folders are added here when you open them or drag them onto Vibe, and stay accessible after a relaunch.", @"Settings, Permissions pane: explanatory text above the list of granted folders.")
