...
How strings, catalogs, and languages work — adding a string, adding a language — is documented in [docs/localization.md](docs/localization.md). To run the app in a specific language without changing anything system-wide:
...
The full Mac App Store release process — credentials, localized product-page assets, metadata upload, and shipping a build — is documented in [docs/app-store-releasing.md](docs/app-store-releasing.md).
