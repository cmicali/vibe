...
| `rates/tone-44100-16.wav`, `-48000-16.wav`, `-88200-24.wav`, `-96000-24.wav`, `-96000-24.flac` | the long tone at the rates and word lengths bit-perfect output switches a DAC to — the loopback oracle's inputs (`verify-bit-perfect.swift`, SKILL.md's *Bit-perfect output*) |
